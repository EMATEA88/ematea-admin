  ...
  return (
    <div className="p-8 bg-[#0B0E11] min-h-screen text-white space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/5 pb-8">
        ...
        <div className="flex items-center gap-3 bg-[#161A1F] px-4 py-2 rounded-xl border border-white/5">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 border border-white/5">
                    <div className="flex items-center gap-2">
                      <img src="/assets/otc/bnb.png" className="w-5 h-5" alt="BNB" />
                  ...
                  <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 border border-white/5">
                    <div className="flex items-center gap-2">
                      <img src="/assets/otc/usdt.png" className="w-5 h-5" alt="USDT" />
                      <span className="text-sm font-medium">USDT Liquidez</span>
                    </div>
                    <span className="text-sm font-bold text-emerald-500">{data.companyWallet.usdt}</span>
                  </div>
                </div>

                <p className="mt-6 text-[10px] text-gray-600 text-center uppercase font-bold tracking-tighter">
                  Assegure-se de manter BNB suficiente para taxas de rede
                </p>
              </div>
            </div>
          )}
...
function StatBox({ label, value, icon }: any) {
  return (
    <div className="bg-[#161A1F]/40 border border-white/5 p-6 rounded-2xl">
