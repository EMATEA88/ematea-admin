  ...
  return (
    <div className="p-6 bg-[#0B0E11] min-h-screen text-white">
      ...
      <div className="space-y-4">
        {pending.length === 0 && (
          <p className="text-gray-500 italic">Nenhuma tarefa aguardando revisão.</p>
        )}
        ...
        {pending.map((item) => (
          <div key={item.id} className="bg-[#1E2329] border border-[#2B3139] p-6 rounded-2xl flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/3">
              <p className="text-xs text-gray-500 mb-2 font-bold uppercase">Prova:</p>
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex gap-3">
                <button
                  ...
                  className="bg-[#02C076] hover:bg-[#02a867] px-6 py-2 rounded-xl font-bold"
                >
                  Aprovar
                </button>
