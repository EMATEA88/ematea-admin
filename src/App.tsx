...
import AdminServiceRequests from "./pages/admin/partners/AdminServiceRequests"
...
import RedotPayAccountPage from './pages/admin/RedotPayAccountPage';
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/admin/redotpay" element={<RedotPayAccountPage />} />
